                                                                                    ...
                                                                                    # n-그램 범위 = 2 가 바이-그램 특징으로 더해질 것
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            if ngram_range > 1:
                                                                                                                                                                                                                    print('Adding {}-gram features'.format(ngram_range))
                                                                                                                                                                                                                        # 훈련 집합에서 특이 n-그램 집합을 만들어라                                                                                                                                                                                                                                                                                                                            ngram_set = set()
                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                            set_of_ngram = create_ngram_set(input_list, ngram_value=i)
                                                                                                                                                                                                                                                                        ngram_set.update(set_of_ngram)
                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                    # 정수 값이 순서대로 max_features 보다 크다
                                                                                                                                                                                                                                                                                       # 기존 형상과 충돌하지 않기 위해                                                                                                                                                                                                                                                                                                                                             start_index = max_features + 1
                                                                                                                                                                                                                                                                                            token_indice = {v: k + start_index for k, v in enumerate(ngram_set)}
                                                                                                                                                                                                                                                                                                indice_token = {token_indice[k]: k for k in token_indice}
                                                                                                                                                                                                                                                                                                 # max_features 은 데이터 집합에서 찾을 수 있는 것중에 가장 큰 정수이다.
                                                                                                                                                                                                                                                                                                        max_features = np.max(list(indice_token.keys())) + 1

                                                                                                                                                                                                                                                                                                            # n그램 기능으로 x_train 및 x_test 증대                                                                                                                                                                                                                                                                                                                                  x_train = add_ngram(x_train, token_indice, ngram_range)
